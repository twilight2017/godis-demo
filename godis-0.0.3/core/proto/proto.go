...
func NewEncoder(w io.Writer) *Encoder{
	return NewEncoderBuffer(bufio2.NewWriteSize(w, 8192))
}
...
//encode TextBytes encode text type
func (e *Encoder) encodeTextBytes(b []type) error{
...
func(d *Decoder) decodeResp() (*Resp, error){
	...
	default:
		return nil, errorsTrace(err)
	case TypeStringm TypeError, TypeInt:
...
//deocdeBulkBytes decode批量回复
func (d *Decoder) decoedBulkBytes() ([]byte, error){
	n, err := d.decodeInt()
    if err != nil{
		return nil, err
	}
